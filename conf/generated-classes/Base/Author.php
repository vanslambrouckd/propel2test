...
abstract class Author implements ActiveRecordInterface 
{
    ...
    /**
     * The value for the birtdate field.
     * @var        \DateTime
     */
    protected $birtdate;
    ...
    /**
     * Get the [optionally formatted] temporal [birtdate] column value.
     * 
     *
     ...
     */
    public function getBirtdate($format = NULL)
    {
        if ($format === null) {
            return $this->birtdate;
        } else {
            return $this->birtdate instanceof \DateTime ? $this->birtdate->format($format) : null;
        }
    }
    ...
    public function setFirstname($v)
    {
        ...
        if ($this->firstname !== $v) {
            $this->firstname = $v;
            $this->modifiedColumns[AuthorTableMap::COL_FIRSTNAME] = true;
        }
    ...
    public function setLastname($v)
    {
        ...
        if ($this->lastname !== $v) {
            $this->lastname = $v;
            $this->modifiedColumns[AuthorTableMap::COL_LASTNAME] = true;
        }
    ...
    /**
     * Sets the value of [birtdate] column to a normalized version of the date/time value specified.
     * 
     * @param  mixed $v string, integer (timestamp), or \DateTime value.
     *               Empty strings are treated as NULL.
     * @return $this|\Author The current object (for fluent API support)
     */
    public function setBirtdate($v)
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->birtdate !== null || $dt !== null) {
            if ($this->birtdate === null || $dt === null || $dt->format("Y-m-d") !== $this->birtdate->format("Y-m-d")) {
                $this->birtdate = $dt === null ? null : clone $dt;
                $this->modifiedColumns[AuthorTableMap::COL_BIRTDATE] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AuthorTableMap::translateFieldName('Birtdate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->birtdate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;
            $this->resetModified();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AuthorTableMap::COL_FIRSTNAME)) {
            $modifiedColumns[':p' . $index++]  = 'firstname';
        }
        if ($this->isColumnModified(AuthorTableMap::COL_LASTNAME)) {
            $modifiedColumns[':p' . $index++]  = 'lastname';
        }
        if ($this->isColumnModified(AuthorTableMap::COL_EMAIL)) {
            $modifiedColumns[':p' . $index++]  = 'email';
        }
        if ($this->isColumnModified(AuthorTableMap::COL_BIRTDATE)) {
            $modifiedColumns[':p' . $index++]  = 'birtdate';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'email':                        
                        ...
                        break;
                    case 'birtdate':                        
                        $stmt->bindValue($identifier, $this->birtdate ? $this->birtdate->format("Y-m-d H:i:s") : null, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AuthorTableMap::COL_FIRSTNAME)) {
            $criteria->add(AuthorTableMap::COL_FIRSTNAME, $this->firstname);
        }
        if ($this->isColumnModified(AuthorTableMap::COL_LASTNAME)) {
            $criteria->add(AuthorTableMap::COL_LASTNAME, $this->lastname);
        }
        if ($this->isColumnModified(AuthorTableMap::COL_EMAIL)) {
            $criteria->add(AuthorTableMap::COL_EMAIL, $this->email);
        }
        if ($this->isColumnModified(AuthorTableMap::COL_BIRTDATE)) {
            $criteria->add(AuthorTableMap::COL_BIRTDATE, $this->birtdate);
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setBirtdate($this->getBirtdate());
