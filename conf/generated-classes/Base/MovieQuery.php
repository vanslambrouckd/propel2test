...
abstract class MovieQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'default', $modelName = '\\Movie', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, title FROM movie WHERE id = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(MovieTableMap::COL_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(MovieTableMap::COL_ID, $keys, Criteria::IN);
    }
    ...
    {
        if ($movie) {
            $this->addUsingAlias(MovieTableMap::COL_ID, $movie->getId(), Criteria::NOT_EQUAL);
        }
