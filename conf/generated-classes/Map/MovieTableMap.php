...
class MovieTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(MovieTableMap::COL_ID, MovieTableMap::COL_TITLE, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(MovieTableMap::COL_ID => 0, MovieTableMap::COL_TITLE => 1, ),
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(MovieTableMap::COL_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(MovieTableMap::COL_ID) && $criteria->keyContainsValue(MovieTableMap::COL_ID) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.MovieTableMap::COL_ID.')');
        }
